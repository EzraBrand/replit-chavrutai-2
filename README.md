# ChavrutAI - Classical Jewish Texts Study Platform
...
- **Jastrow Dictionary** (`/jastrow`) — Talmudic Hebrew & Aramaic; search, browse by letter, autosuggest, internal cross-references, Mishnah and Talmud links to ChavrutAI pages
- **Brown-Driver-Briggs (BDB)** (`/bdb`) — Biblical Hebrew lexicon with verbal stem labels, numbered section labels, Bible citations linked to the ChavrutAI Bible reader, and scholar abbreviation expansion
