    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main className="max-w-content mx-auto px-6">
        ...
        <div className="pt-10 pb-8">
          <h1 className="font-georgia text-3xl md:text-4xl text-foreground mb-2">Privacy Policy</h1>
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Overview</h2>
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Information We Collect</h2>
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">How We Use Your Information</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Information Sharing and Disclosure</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Data Storage and Security</h2>
          <ul className="list-disc list-inside space-y-2 mb-4 text-muted-foreground ml-4">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Your Rights and Choices</h2>
          <ul className="list-disc list-inside space-y-2 mb-4 text-muted-foreground ml-4">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Third-Party Services</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Children's Privacy</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">International Users</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Changes to This Privacy Policy</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        {/* Contact Section */}
        <section className="py-8 border-t border-border">
          <h2 className="font-georgia text-xl text-foreground mb-4">Contact Us</h2>
          <p className="text-muted-foreground leading-relaxed mb-4">
