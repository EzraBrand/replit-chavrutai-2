...
const HONORIFIC1 =
  '(?:' + [
    ...
    'the son of Rebbi', '(?<![a-zA-Z])son of Rebbi', 'bar Rebbi', 'ben Rebbi',
    'the grandson of Rebbi', '(?<![a-zA-Z])grandson of Rebbi',
    'the brother of Rebbi', '(?<![a-zA-Z])brother of Rebbi',
    'the father of Rebbi', '(?<![a-zA-Z])father of Rebbi',
    'the wife of Rebbi', 'The wife of Rebbi',
    'The daughter of Rebbi', 'the daughter of Rebbi',
    'the son of the daughter of Rebbi', '(?<![a-zA-Z])son of the daughter of Rebbi',
    'Rebbi',
    'R\\.',
    // Original patterns
    'the son of Rav', 'the son of Rabbi', 'bar Rabbi', 'ben Rabbi',
    '(?<![a-zA-Z])son of Rabbi', '(?<![a-zA-Z])son of Rav',
    'the son of', '(?<![a-zA-Z])son of',
    'the grandson of Rav', 'the grandson of Rabbi',
    '(?<![a-zA-Z])grandson of Rabbi', '(?<![a-zA-Z])grandson of Rav',
    'the brother of Rav', 'the brother of Rabbi',
    '(?<![a-zA-Z])brother of Rabbi', '(?<![a-zA-Z])brother of Rav',
    'the father of Rav', 'the father of Rabbi',
    '(?<![a-zA-Z])father of Rabbi', '(?<![a-zA-Z])father of Rav',
