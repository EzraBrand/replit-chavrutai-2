          ...
          <div className="space-y-4 text-sepia-700 dark:text-sepia-300">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Period → question mark for rhetorical openers: <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">מה עבד.</code> → <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">מה עבד?</code> and <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">מה טעם.</code> → <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">מה טעם?</code></li>
                <li>Period → exclamation for the vocative: <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">רבי.</code> → <code className="text-xs bg-sepia-200 dark:bg-sepia-700 px-1 rounded">רבי!</code></li>
              </ul>
            </div>
