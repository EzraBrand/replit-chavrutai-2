          ...
          <div className="space-y-4 text-sepia-700 dark:text-sepia-300">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Scholars / sources: <strong>Boch</strong> / <strong>Boch.</strong> (Bochart); <strong>Origen Hom</strong> → Origen Homilies; <strong>Tsepreghi (Diss. Lugd.</strong> → Csepreghi (Leiden dissertation).</li>
