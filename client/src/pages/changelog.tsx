          ...
          <div className="space-y-4 text-sepia-700 dark:text-sepia-300">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Scholars / sources: <strong>G. Jacob</strong> (Georg Jacob); <strong>Arab. Dicht.</strong> (Arabischen Dichtern); <strong>Yakut</strong> (Yaqut al-Hamawi); <strong>Altisr. Kultst.</strong> (Altisraelitische Kultstätten); <strong>Rel.Gesch.</strong> (Religions-geschichte); <strong>RS (Sem</strong> → W. Robertson Smith (Religion of Semites).</li>
              </ul>
            </div>
